...
- Create: `labs/go/01-syntax/{LAB.md,CHECK.md,go.mod,main.go}`
- Create: `labs/go/02-values-pointers/{LAB.md,CHECK.md,go.mod,main.go,main_test.go}`
- Create: `labs/go/03-arrays-strings-slices/{LAB.md,CHECK.md,go.mod,main.go,main_test.go}`
- Create: `labs/go/04-maps/{LAB.md,CHECK.md,go.mod,main.go,main_test.go}`
- Create: `labs/go/05-structs-methods/{LAB.md,CHECK.md,go.mod,main.go,main_test.go}`
- Create: `labs/go/06-errors-panic/{LAB.md,CHECK.md,go.mod,main.go,main_test.go}`
- Create: `labs/go/07-interfaces/{LAB.md,CHECK.md,go.mod,main.go,main_test.go}`
- Create: `labs/go/08-tests-bench-fuzz/{LAB.md,CHECK.md,go.mod,calc.go,calc_test.go}`
- Create: `labs/go/09-memory-gc/{LAB.md,CHECK.md,DEEP_DIVE.md,go.mod,main.go}`
- Create: `labs/go/10-pprof/{LAB.md,CHECK.md,DEEP_DIVE.md,go.mod,main.go}`
...
- Create: `labs/concurrency/channels/{LAB.md,CHECK.md,channels.go,channels_test.go}`
- Create: `labs/concurrency/context/{LAB.md,CHECK.md,context.go,context_test.go}`
- Create: `labs/concurrency/race/{LAB.md,CHECK.md,race.go,race_test.go}`
- Create: `labs/concurrency/deadlock/{LAB.md,CHECK.md,main.go}`
- Create: `labs/concurrency/workerpool/{LAB.md,CHECK.md,pool.go,pool_test.go}`
- Create: `labs/concurrency/semaphore/{LAB.md,CHECK.md,semaphore.go,semaphore_test.go}`
- Create: `labs/concurrency/pipeline/{LAB.md,CHECK.md,pipeline.go,pipeline_test.go}`
- Create: `labs/concurrency/shutdown/{LAB.md,CHECK.md,main.go,main_test.go}`
...
- Create: `labs/http/{README.md,LAB.md,CHECK.md,go.mod,cmd/server/main.go,internal/api/handler.go,internal/api/middleware.go,internal/api/handler_test.go,internal/client/client.go,internal/client/client_test.go}`
...
- Create: `labs/postgres/sql/01-ddl-dml.sql`
- Create: `labs/postgres/sql/02-transactions.sql`
- Create: `labs/postgres/sql/03-isolation.sql`
- Create: `labs/postgres/sql/04-locks.sql`
- Create: `labs/postgres/sql/05-skip-locked.sql`
- Create: `labs/postgres/sql/06-indexes.sql`
- Create: `labs/postgres/sql/07-explain.sql`
- Create: `labs/postgres/sql/08-logical-replication.sql`
- Create: `labs/postgres/scripts/seed.sql`
- Create: `labs/postgres/scripts/locks.sh`
- Create: `labs/postgres/scripts/deadlock.sh`
...
- Create: `labs/redis/{README.md,LAB.md,CHECK.md,go.mod,cache.go,cache_test.go,pubsub.go,streams.go}`
- Create: `labs/kafka/{README.md,LAB.md,CHECK.md,go.mod,producer.go,consumer.go,idempotency.go,idempotency_test.go}`
- Create: `labs/architecture/{README.md,cap-scenarios.md,consistent-hashing.md,outbox-saga.md,go.mod,hashring.go,hashring_test.go}`
- Create: `labs/nginx/{README.md,LAB.md,CHECK.md,go.mod,cmd/replica/main.go}`
